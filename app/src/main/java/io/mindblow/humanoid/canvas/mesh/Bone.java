...
public class Bone {
    ...
    public void orient(MasterContext masterContext, float[] matrix) {
        FusionData fusionData = masterContext.get(this.segment);
        if (fusionData != null) {
    ...
    public void reorient(MasterContext masterContext, float[] matrix) {
        FusionData fusionData = masterContext.get(this.segment);
        if (fusionData != null) {
            Matrix.rotateM(matrix, 0, -fusionData.pitch, 1, 0, 0);
            Matrix.rotateM(matrix, 0, fusionData.roll, 0, 1, 0);
    ...
    public void redraw(MasterContext masterContext, float[] mvpMatrix) {
